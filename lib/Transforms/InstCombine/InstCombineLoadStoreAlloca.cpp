...
static LoadInst *combineLoadToNewType(llvm_seahorn::InstCombiner &IC, LoadInst &LI, Type *NewTy,
                                      const Twine &Suffix = "") {
...
static StoreInst *combineStoreToNewValue(llvm_seahorn::InstCombiner &IC, StoreInst &SI, Value *V) {
...
/// into a phi node with a store in the successor.
///
bool llvm_seahorn::InstCombiner::SimplifyStoreAtEndOfBlock(StoreInst &SI) {
