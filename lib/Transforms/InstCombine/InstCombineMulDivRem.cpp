...
/// \brief A helper routine of llvm_seahorn::InstCombiner::visitMul().
///
...
bool llvm_seahorn::InstCombiner::willNotOverflowSignedMul(const Value *LHS,
                                            const Value *RHS,
...
/// Helper function of llvm_seahorn::InstCombiner::visitFMul(BinaryOperator(). It returns
...
/// foldFMulConst() is a helper routine of llvm_seahorn::InstCombiner::visitFMul().
...
///
Value *llvm_seahorn::InstCombiner::foldFMulConst(Instruction *FMulOrDiv, Constant *C,
...
bool llvm_seahorn::InstCombiner::SimplifyDivRemOfSelect(BinaryOperator &I) {
