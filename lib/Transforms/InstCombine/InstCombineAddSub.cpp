...
namespace {
  ...
  class FAddCombine {
  public:
    FAddCombine(llvm_seahorn::InstCombiner::BuilderTy &B) : Builder(B), Instr(nullptr) {}
...
bool llvm_seahorn::InstCombiner::willNotOverflowSignedSub(const Value *LHS,
                                            const Value *RHS,
...
bool llvm_seahorn::InstCombiner::willNotOverflowUnsignedSub(const Value *LHS,
                                              const Value *RHS,
                                              const Instruction &CxtI) const {
