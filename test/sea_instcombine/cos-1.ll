...
; RUN: %instcombine %s -S | %FileCheck %s --check-prefixes=ANY,NO-FLOAT-SHRINK
; RUN: %instcombine %s -enable-double-float-shrink -S | %FileCheck %s --check-prefixes=ANY,DO-FLOAT-SHRINK
