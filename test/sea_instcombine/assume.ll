...
; RUN: %instcombine %s -S | %FileCheck --check-prefixes=CHECK,DEFAULT %s
; RUN: %instcombine %s --enable-knowledge-retention -S | %FileCheck --check-prefixes=CHECK,BUNDLES %s

; RUN: %instcombine %s -S --try-experimental-debuginfo-iterators | %FileCheck --check-prefixes=CHECK,DEFAULT %s
; RUN: %instcombine %s --enable-knowledge-retention -S --try-experimental-debuginfo-iterators | %FileCheck --check-prefixes=CHECK,BUNDLES %s
