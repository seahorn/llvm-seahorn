...
; RUN: %instcombine %s -S -mtriple "i386-pc-linux" | %FileCheck %s
; RUN: %instcombine %s -S -mtriple "i386-pc-win32" | %FileCheck %s
; RUN: %instcombine %s -S -mtriple "x86_64-pc-win32" | %FileCheck %s
; RUN: %instcombine %s -S -mtriple "i386-pc-mingw32" | %FileCheck %s
; RUN: %instcombine %s -S -mtriple "x86_64-pc-mingw32" | %FileCheck %s
; RUN: %instcombine %s -S -mtriple "sparc-sun-solaris" | %FileCheck %s
