; RUN: %instcombine %s -data-layout="p:32:32" -S | %FileCheck %s --check-prefixes=CHECK,CHECK32
; RUN: %instcombine %s -data-layout="p:64:64" -S | %FileCheck %s --check-prefixes=CHECK,CHECK64
