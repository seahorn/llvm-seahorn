...
; RUN: %instcombine %s -S -data-layout=n32 | %FileCheck %s --check-prefix=ALL --check-prefix=CHECK32
; RUN: %instcombine %s -S -data-layout=n32:64 | %FileCheck %s --check-prefix=ALL --check-prefix=CHECK64
