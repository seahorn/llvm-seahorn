...
; RUN: %instcombine %s -S -data-layout=e-n32 | %FileCheck %s --check-prefix=ALL --check-prefix=LE
; RUN: %instcombine %s -S -data-layout=E-n32 | %FileCheck %s --check-prefix=ALL --check-prefix=BE
