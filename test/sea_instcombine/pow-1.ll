...
; rdar://7251832
; RUN: %instcombine -S %s -mtriple=i386-pc-windows-msvc18 | %FileCheck %s --check-prefixes=CHECK,LIB,CHECK-NO-EXP10,VC32
; RUN: %instcombine -S %s -mtriple=i386-pc-windows-msvc | %FileCheck %s --check-prefixes=CHECK,LIB,CHECK-NO-EXP10,VC19,VC51
; RUN: %instcombine -S %s -mtriple=x86_64-pc-windows-msvc18 | %FileCheck %s --check-prefixes=CHECK,LIB,CHECK-NO-EXP10,VC64
; RUN: %instcombine -S %s -mtriple=x86_64-pc-windows-msvc | %FileCheck %s --check-prefixes=CHECK,LIB,CHECK-NO-EXP10,VC19,VC83
; RUN: %instcombine -S %s -mtriple=amdgcn-- | %FileCheck %s --check-prefixes=CHECK,CHECK-NO-EXP10,NOLIB
