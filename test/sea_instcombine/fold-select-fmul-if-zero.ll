...
; RUN: %instcombine -S %s | %FileCheck -check-prefixes=CHECK,IEEE %s
; RUN: %instcombine -S -denormal-fp-math=preserve-sign %s | %FileCheck -check-prefixes=CHECK,DAZ %s
; RUN: %instcombine -S -denormal-fp-math=positive-zero %s | %FileCheck -check-prefixes=CHECK,DAPZ %s
