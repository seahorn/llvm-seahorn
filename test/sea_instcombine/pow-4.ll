...
; RUN: %instcombine -S %s -mtriple unknown | %FileCheck %s --check-prefixes=CHECK,CHECKI32,CHECKSQRT
; RUN: %instcombine -S %s -mtriple unknown -disable-builtin sqrt | %FileCheck %s --check-prefixes=CHECK,CHECKI32,CHECKNOSQRT
