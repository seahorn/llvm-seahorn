...
; RUN: %instcombine -S %s -mtriple unknown -data-layout=e | %FileCheck %s --check-prefixes=CHECK,CHECKI32,CHECKSQRT
; RUN: %instcombine -S %s -mtriple unknown -data-layout=e -disable-builtin sqrt | %FileCheck %s --check-prefixes=CHECK,CHECKI32,CHECKNOSQRT
; RUN: %instcombine -S %s -mtriple msp430 | %FileCheck %s --check-prefixes=CHECK,CHECKI16,CHECKSQRT
; RUN: %instcombine -S %s -mtriple msp430 -disable-builtin sqrt | %FileCheck %s --check-prefixes=CHECK,CHECKI16,CHECKNOSQRT
