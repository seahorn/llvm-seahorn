; RUN: %instcombine %s -S -mtriple=i386-pc-windows-msvc18 | %FileCheck %s --check-prefixes=CHECK,MSVCXX,MSVC32
; RUN: %instcombine %s -S -mtriple=i386-pc-windows-msvc | %FileCheck %s --check-prefixes=CHECK,MSVC19,MSVC51
; RUN: %instcombine %s -S -mtriple=x86_64-pc-windows-msvc17 | %FileCheck %s --check-prefixes=CHECK,MSVCXX,MSVC64
; RUN: %instcombine %s -S -mtriple=x86_64-pc-win32 | %FileCheck %s --check-prefixes=CHECK,MSVC19,MSVC83
; RUN: %instcombine %s -S -mtriple=i386-pc-mingw32 | %FileCheck %s --check-prefixes=CHECK,MINGW32
; RUN: %instcombine %s -S -mtriple=x86_64-pc-mingw32 | %FileCheck %s --check-prefixes=CHECK,MINGW64
