...
; RUN: %instcombine -S %s -mtriple=unknown | %FileCheck -check-prefixes=CHECK,CHECK32 %s
; RUN: %instcombine -S %s -mtriple=msp430 | %FileCheck -check-prefixes=CHECK,CHECK16 %s
