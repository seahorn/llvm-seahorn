...
; RUN: %instcombine -S %s -mtriple=arm-apple-ios7.0 | %FileCheck %s
; RUN: %instcombine -S %s -mtriple=arm64-apple-ios7.0 | %FileCheck %s
; RUN: %instcombine -S %s -mtriple=x86_64-apple-macosx10.8 | %FileCheck %s --check-prefix=CHECK-NO-SINCOS
; RUN: %instcombine -S %s -mtriple=arm-apple-ios6.0 | %FileCheck %s --check-prefix=CHECK-NO-SINCOS
; RUN: %instcombine -S %s -mtriple=x86_64-none-linux-gnu | %FileCheck %s --check-prefix=CHECK-NO-SINCOS
