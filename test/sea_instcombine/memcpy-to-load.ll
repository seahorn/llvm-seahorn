...
; RUN: %instcombine %s -S -data-layout=n32 | %FileCheck %s
; RUN: %instcombine %s -S -data-layout=n32:64 | %FileCheck %s
; RUN: %instcombine %s -S -data-layout=n32:64:128 | %FileCheck %s
