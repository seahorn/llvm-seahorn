...
; RUN: %instcombine %s -S -data-layout="n8:16:32:64" | %FileCheck %s --check-prefixes=CHECK,DL64
; RUN: %instcombine %s -S -data-layout="n8" | %FileCheck %s --check-prefixes=CHECK,DL8
