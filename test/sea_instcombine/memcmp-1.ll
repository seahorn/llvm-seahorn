...
;
; RUN: %instcombine %s -S | %FileCheck --check-prefix=CHECK --check-prefix=NOBCMP %s
; RUN: %instcombine %s -mtriple=x86_64-unknown-linux-gnu -S | %FileCheck --check-prefix=CHECK --check-prefix=BCMP %s
