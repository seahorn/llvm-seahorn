...
; RUN: %instcombine %s -S -data-layout="E" | %FileCheck %s --check-prefixes=CHECK,BE-CHECK
; RUN: %instcombine %s -S -data-layout="e" | %FileCheck %s --check-prefixes=CHECK,LE-CHECK
;
