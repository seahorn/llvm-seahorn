...
; RUN: %instcombine %s -S -data-layout="e-n64" | %FileCheck %s --check-prefixes=ANY,ANYLE,LE64
; RUN: %instcombine %s -S -data-layout="e-n128" | %FileCheck %s --check-prefixes=ANY,ANYLE,LE128
; RUN: %instcombine %s -S -data-layout="E-n64" | %FileCheck %s --check-prefixes=ANY,ANYBE,BE64
; RUN: %instcombine %s -S -data-layout="E-n128" | %FileCheck %s --check-prefixes=ANY,ANYBE,BE128
