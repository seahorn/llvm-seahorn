...
;
; RUN: %instcombine %s -S -mtriple=unknown | %FileCheck %s -check-prefixes=LDEXP32
; RUN: %instcombine %s -S -mtriple=msp430 | %FileCheck %s -check-prefixes=LDEXP16
; RUN: %instcombine %s -S -mtriple=i386-pc-win32 | %FileCheck %s -check-prefixes=NOLDEXPF
; RUN: %instcombine %s -S -mtriple=amdgcn-unknown-unknown | %FileCheck %s -check-prefixes=NOLDEXP
