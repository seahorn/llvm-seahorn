...
bool llvm::runPassPipeline(StringRef Arg0, Module &M, TargetMachine *TM,
  ...
  // LLVM 17: PGOOptions gained MemoryProfile (string) + FS (filesystem) params.
  // We don't expose -memory-profile-file, so MemoryProfile is "".
  ...
  case NoPGO:
    if (DebugInfoForProfiling || PseudoProbeForProfiling)
      P = PGOOptions("", "", "", "", FS, PGOOptions::NoAction,
